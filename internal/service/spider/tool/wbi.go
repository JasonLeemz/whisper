...
func Test() {
	...
	urlStr := "https://api.bilibili.com/x/space/wbi/arc/search?keyword=婕拉&pn=1&tid=0&web_location=1550101&ps=30&mid=2020130976&order=pubdate&order_avoided=true&platform=web"
