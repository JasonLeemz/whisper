        ...
        <template v-if="heroResult.data.platform===1">
          <a-popover placement="topLeft">
            <template #content>
              ...
              <span class="hero-suit popover-content"
                    v-html="heroResult.data.ext_info.recommend_reason[pos]"></span>
            </template>
            <h4 class="pos-title">
              {{ pos }}
              <h6>
                  ...
                  <a-popover placement="bottom" arrow-point-at-center>
                    ...
                    <div class="rune-desc-img">
                      ...
                      <div :class="rowidx==='rune'?'rune-desc-img-wrap':''">
                        <img :src="equip.icon" :alt="equip.name"
                             :class="rowidx==='rune'?'equip-icon-rune':'equip-icon'">
